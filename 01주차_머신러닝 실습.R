...
# 비만이면서 흡연하면 굉장히 큰 값이 나온다는 것을 알 수 있음
...
vif(fit2)
Anova(fit2,type=3) #변수 중요도를 보는 통계적 기법(회귀)
#bmi30은 유의하지 않지만 interactoin은 유의하니까 빼면 안돼!

#평가지표 rmse, 겁나 못만든 모델이구나~ ㅎㅎ (요금이라서 rmse)
